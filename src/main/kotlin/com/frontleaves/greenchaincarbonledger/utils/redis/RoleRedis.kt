...
class RoleRedis(
     ...
     * @return 返回List
     */
    fun getList(businessConstants: BusinessConstants): List<String>? {
        val pattern = RedisConstant.TYPE_AUTH + RedisConstant.TABLE_ROLE + businessConstants.value + "*"
        return super.getList(pattern)
    }
