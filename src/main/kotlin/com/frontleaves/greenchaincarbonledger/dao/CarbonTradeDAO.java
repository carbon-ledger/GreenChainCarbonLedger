...
public class CarbonTradeDAO {
    ...
    public void editTrade(String uuid, TradeReleaseVO tradeReleaseVO, String status, String id) {
        log.info("[DAO] 执行 editTrade");
        log.info("\t> Mysql 更新");
        carbonMapper.updateTradeByUuid(uuid, tradeReleaseVO.getAmount(), tradeReleaseVO.getUnit(), tradeReleaseVO.getText(), status, id);
    }
