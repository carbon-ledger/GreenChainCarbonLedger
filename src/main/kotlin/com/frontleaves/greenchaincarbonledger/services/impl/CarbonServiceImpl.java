...
public class CarbonServiceImpl implements CarbonService {
    ...
    @NotNull
    @Override
    public ResponseEntity<BaseResponse> getCarbonReport(long timestamp, @NotNull @jakarta.validation.constraints.NotNull HttpServletRequest request, @NotNull String type, @NotNull String search, @Nullable Integer limit, @Nullable Integer page, @NotNull String order) {
