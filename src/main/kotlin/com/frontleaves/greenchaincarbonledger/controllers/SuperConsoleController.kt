...
class SuperConsoleController(
    ...
    fun resetSql() {
        ...
        listOf(
            ...
            "TRUNCATE TABLE fy_carbon_accounting",
            "TRUNCATE TABLE fy_carbon_compensation_material",
            "TRUNCATE TABLE fy_carbon_item_type",
            "TRUNCATE TABLE fy_carbon_quota",
            "TRUNCATE TABLE fy_carbon_report",
            "TRUNCATE TABLE fy_carbon_trade",
            "TRUNCATE TABLE fy_carbon_type",
            "TRUNCATE TABLE fy_desulfurization_factor",
