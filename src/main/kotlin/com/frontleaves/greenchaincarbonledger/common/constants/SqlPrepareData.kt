...
object SqlPrepareData {
    ...
    val PERMISSION_LIST = ArrayList<ArrayList<String>>().apply {
        ...
        add(ArrayList(listOf("user:getUserByUuid", "获取用户信息")))
        ...
        add(ArrayList(listOf("carbon:getCarbonItemType", "获取碳排放类型")))
        add(ArrayList(listOf("carbon:getCarbonFactorProcess", "获取碳排放过程因子")))
        add(ArrayList(listOf("carbon:getCarbonFactorDesulfurization", "获取碳排放脱硫因子")))
        add(ArrayList(listOf("carbon:getCarbonFactorOther", "获取碳排放其他因子")))
        add(ArrayList(listOf("carbon:getCarbonReviewReport", "获取碳交易审核报告")))
        add(ArrayList(listOf("carbon:getCarbonMaterial", "获取碳核算原料")))
        add(ArrayList(listOf("carbon:getCarbonReviewCheck", "碳报告审核")))
